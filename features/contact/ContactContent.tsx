const ContactContent = () => {
    return (
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-8 text-white gap-10">
            <span className="contact-tag tracking-[0.3em] uppercase text-sm text-red-700">
                - Contact
            </span>

            <h1 className="contact-title font-[family-name:var(--font-heading)] text-5xl md:text-7xl text-gray-900">
                Let’s connect
            </h1>

            <p className="contact-description max-w-[500px] text-gray-600 font-[family-name:var(--font-body)] leading-relaxed">
